...
const Dependant = () => {
    ...
    const { data: comments, status } = useQuery({
        //although both queries will be triggered but this query status is pending until post.id is truthy
    ...
    return (
        <div className="p-12">
            ...
            <br />
            <h1 className="text-lg font-bold">Comments:{status === 'pending' && ""}</h1>
            <ul>
